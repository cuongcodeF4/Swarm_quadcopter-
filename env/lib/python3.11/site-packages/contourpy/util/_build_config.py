...
def build_config() -> dict[str, str]:
    ...
    return dict(
        ...
        # Misc meson settings
        meson_backend="ninja",
        build_dir=r"/tmp/pip-wheel-cnpt_zvx/contourpy_9dc28fb1cff944599ab8b0ac4af02a5f/.mesonpy-9kk9hjy5/lib/contourpy/util",
        source_dir=r"/tmp/pip-wheel-cnpt_zvx/contourpy_9dc28fb1cff944599ab8b0ac4af02a5f/lib/contourpy/util",
        cross_build="False",

        # Build options
        build_options=r"-Dbuildtype=release -Db_ndebug=if-release -Db_vscrt=md -Dvsenv=True --native-file=/tmp/pip-wheel-cnpt_zvx/contourpy_9dc28fb1cff944599ab8b0ac4af02a5f/.mesonpy-9kk9hjy5/meson-python-native-file.ini",
        buildtype="release",
        cpp_std="c++17",
        debug="False",
        optimization="3",
