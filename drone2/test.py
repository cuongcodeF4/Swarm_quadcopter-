...
drone2 = mavutil.mavlink_connection('127.0.0.1:14560')
drone2.target_system = 2  # Thiết lập System ID cho drone1
drone2.target_component = 1  # Thiết lập Component ID cho drone1
