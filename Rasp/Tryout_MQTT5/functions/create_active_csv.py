...
def perform_maneuver(shape_fcn, maneuver_time, diameter, direction, initial_altitude, step_time, shape_args, writer, start_time, last_step, start_coordinates, yaw,mode=70):
    """
    ...
    maneuver_start_x, maneuver_start_y = shape_fcn(0,yaw, maneuver_time, diameter, direction, initial_altitude, step_time, *shape_args)[:2]

    for step in range(move_steps):
        x, y, z, vx, vy, vz, ax, ay, az = shape_fcn(step,yaw, maneuver_time, diameter, direction, initial_altitude, step_time, *shape_args)
        x += start_x
        y += start_y
        x -= maneuver_start_x
        y -= maneuver_start_y
        ...
        row = [missionTime, x, y, z, vx, vy, vz, ax, ay, az, yaws, mode]
        writer.writerow(row)
...
def repeat_maneuver(num_repeats, shape_fcn, maneuver_time, diameter, direction, initial_altitude, step_time, shape_args, writer, last_time, last_step, last_coordinates, hold_time, move_speed, start_coordinates,yaw , mode_move=100, mode_hold=80):
    """
    ...
    for _ in range(num_repeats):
        ...
        last_time, last_step, last_coordinates = perform_maneuver(shape_fcn, maneuver_time, diameter, direction, initial_altitude, step_time, shape_args, writer, start_time, last_step, last_coordinates,yaw)
