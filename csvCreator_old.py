...
def create_active_csv(shape_name,diameter, direction, maneuver_time, start_x, start_y, initial_altitude, move_speed, hold_time , step_time, output_file="active.csv"):
